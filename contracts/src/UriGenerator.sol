...
contract TokenURIGenerator is IUriGenerator {
    /// @inheritdoc IUriGenerator
    ...
    function generateName(UriParams memory params) public pure returns (string memory) {
    ...
    function generateDescription(UriParams memory params) public pure returns (string memory) {
        return string(
            abi.encodePacked(
                "NFT representing a exercise options contract. ",
    ...
    function generateNFT(UriParams memory params) public view returns (string memory) {
      uint8 exerciseDecimals = 11;
        ...
        return string(
            abi.encodePacked(
                ...
                "</g>",
                _generateHeaderSection( params.exerciseSymbol),
        ...
        return string(
            abi.encodePacked(
                abi.encodePacked(
                    ...
                    "<text x='16px' y='80px' font-size='16' fill='#fff' font-family='Helvetica' font-weight='300'>  Call</text>"
            )
        );
    }
    ...
    function _generateDateSection(UriParams memory params) internal pure returns (string memory) {
        return string(
            abi.encodePacked(
